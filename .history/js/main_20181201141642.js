...
function removeItem(e,id){
    console.log(id);
    var idElements = document.querySelectorAll(`[data-id]=${id}`);
    idElements.forEach((node)=>node.remove());
}
...
function renderFromData(data){
    if ('content' in document.createElement('template')) {
        ...
        //     th.rows[0].appendChild(clone);
        //     var td = document.createElement('td');
        //     td.textContent = data.products.featuresList.values[value];
        //     tdObject[id] = td;
